...
describe('SizeConverterImpl', () => {
    ...
    describe('convertToBytes', () => {
        ...
        it('should handle large sizes correctly', () => {
            ...
            expect(sizeConverter.convertToBytes(1_000, 'TB')).toBe(1_000_000_000_000_000);
        });
    });
    ...
    describe('formatSize', () => {
        it('should correctly format sizes without fractional parts', () => {
            ...
            expect(sizeConverter.formatSize(1_000_000_000_000n, 'GB')).toBe('1000 GB');
            expect(sizeConverter.formatSize(1_000_000_000_000_000n, 'TB')).toBe('1000 TB');
        });
        ...
        it('should correctly format sizes with fractional parts', () => {
            ...
            expect(sizeConverter.formatSize(1_500_123_456n, 'GB')).toBe('1.500123456 GB');
            expect(sizeConverter.formatSize(1_000_567_890_123n, 'TB')).toBe('1.000567890123 TB');
        });
    });
});
